...
import { Settings, ChevronRight } from 'lucide-react'; // ✅ Lucide 아이콘
  ...
  return (
    ...
    <div className="w-full h-dvh">
      ...
      <div className="bg-white-100 px-4">
        ...
        {/* 상단 영역 */}
        <div
          className="bg-white rounded-2xl p-4 mt-4 mb-4 relative shadow-even">
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className="text-sm text-white bg-blue-300 px-2 py-1 rounded-xl">관리자</span>
          </div>
        </div>
      </div>
